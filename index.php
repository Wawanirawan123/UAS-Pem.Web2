  ...
  <body>
    ...
    <nav class="navbar navbar-light bg-success object-fit-cover border rounded mt-3">
        <div class="container-fluid">
          <a class="navbar-brand"><img src="image/bumn " class="rounded float-start" alt=""></a>
    ...
    <div class="container">
        ...
        <figcaption class="blockquote-footer">
          <cite title="Source Title">PT Sawit Sejahtera</cite>
        </figcaption>
      </figure>
      <h1>Selamat Datang</h1>
      <p>PT Sawit Sejahtera telah berdiri sejak 2010 dan telah menghasilkan buah hingga luar negri</p>
        <a href="login.php">
        ...
        <img src="image/pt.sawit" style="background-size:cover" >
    </div>
    </body>
</html>